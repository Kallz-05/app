...
if menu == "Nama Pengembang":
    ...
    if uploaded_file is not None:
        ...
        if image is not None:
            ...
            st.image(rotated_image, caption=f"Rotated Image (Angle: {angle}°)", channels="BGR")
            ...
            st.image(translated_image, caption=f"Translated Image (Tx: {tx}, Ty: {ty})", channels="BGR")
            ...
            st.image(skewed_image, caption=f"Skewed Image (Skew X: {skew_x}, Skew Y: {skew_y})", channels="BGR")
